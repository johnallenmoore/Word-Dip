...
#lightbox-mail {
 ...
 left:50%;
 width:750px;
 background-image:url('FunApp.png');
						...
						<form method="post" action="user_pay_success.php" id="formID">
							<div class="input_value_box_cov">
								<div class="inpu_boxes">
									<input name="word_txt1" id="word_txt1" type="text" placeholder="type your content here" class="validate[required,custom[notspaceallow]]" style="width:228px; margin:0 10px 0 0;  float:left; background:#3b2a18; height:25px; color:#FFFFFF; font-weight:bold;" />
									<input name="word_txt2" id="word_txt2" type="text" placeholder="type your content here" class="validate[required,custom[notspaceallow]]" style="width:228px; float:left; background:#3b2a18; height:25px; color:#ffffff; font-weight:bold;"/>
								</div>
								<div class="post_btn">
