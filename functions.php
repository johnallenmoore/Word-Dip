...
/*function password_gen1(){
	
	$pwd1="";
	for($i=0;$i<rand(8,8);$i++)
		{ 
		  $num1=rand(48,122);
		  if(($num1 >= 97 && $num1 <= 122))  {   $pwd1.=chr($num1);}
		  else if(($num1 >= 65 && $num1 <= 90)) {  $pwd1.=chr($num1);}
		  else if(($num1 >=48 && $num1 <= 57))   {  $pwd1.=chr($num1);}
		  else    $i--;
		}
	return $pwd1; 
