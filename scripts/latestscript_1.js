...
function  rasi_add_front(p){
	...
	$.ajax({
		type: "POST",
		url: "ajax/rasi_add_jathagam.php",	
	...
	$.ajax({
		type: "POST",
		url: "ajax/rasi_remove_jathagam.php",	
...
function  amsam_add_front(p){
	...
	$.ajax({
		type: "POST",
		url: "ajax/amsam_add_jathagam.php",	
	...
	$.ajax({
		type: "POST",
		url: "ajax/amsam_remove_jathagam.php",	
...
function  rasi_remove_front (p){
	...
	$.ajax({
		type: "POST",
		url: "ajax/rasi_remove_jathagam_del.php",	
		data: "&user_id="+p+"&val="+x,					
		success: function(html){					
			$("#rasi_remove_span").html(html);				//Calling the responce IDs						
		}
...
function  amsam_remove_front(p){
	...
	$.ajax({
		type: "POST",
		url: "ajax/amsam_remove_jathagam_del.php",	
		data: "&user_id="+p+"&val="+x,					
		success: function(html){					
			$("#amsam_remove_span").html(html);				//Calling the responce IDs						
		}
