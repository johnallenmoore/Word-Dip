...
function load_city_name1(state_id){
	$.ajax({
		type: "POST",
		url: "ajax/city_select1.php",	//Calling the ajax process php url	
		data: "&state_id="+state_id,				
		success: function(html){					
			$("#load_city_name_out1").html(html);				//Calling the responce IDs						
		}
	});
...
function load_state_name(country_id){
	$.ajax({
		type: "POST",
		url: "ajax/state_select.php",	//Calling the ajax process php url	
		data: "&country_id="+country_id,				
		success: function(html){					
			$("#load_state_name_out").html(html);				//Calling the responce IDs						
		}
	});
...
function reg_image_upload_delete(a){
	     $.ajax({
			type: "POST",
			url: "ajax/reg_upload_albums.php",	//Calling the ajax process php url				
			data: "&delete_id="+a,	
			success: function(html){			
				...
				$("#reg_image_upload_delete_output").html(html);				//Calling the responce IDs			
...
function search_religion_load(a){
	$.ajax({
		  type: "POST",
		  url: "ajax/search_religion_load.php",
		  data: "&re_id="+a,
		  success: function(html){		
		  $("#search_relig_id").html(html);//Calling the responce IDs
		  }
	});
}

function search_religion_load123(a){
	$.ajax({
		  type: "POST",
		  url: "ajax/search_religion_load123.php",
		  data: "&re_id="+a,
		  success: function(html){		
		  $("#search_relig_id123").html(html);//Calling the responce IDs
		  }
	});
}

function search_state_load(a){
	$.ajax({
		  type: "POST",
		  url: "ajax/search_state_load.php",
		  data: "&re_id="+a,
		  success: function(html){		
		  $("#search_state_id").html(html);//Calling the responce IDs
		  }
	});
}

function search_state_load1(a){
	$.ajax({
		  type: "POST",
		  url: "ajax/search_state_load1.php",
		  data: "&re_id="+a,
		  success: function(html){		
		  $("#search_state_id1").html(html);//Calling the responce IDs
		  }
	});
}

function search_city_load(a){
	$.ajax({
		  type: "POST",
		  url: "ajax/search_city_load.php",
		  data: "&re_id="+a,
		  success: function(html){		
		  $("#search_city_id").html(html);//Calling the responce IDs
		  }
	});
}


function religion_register_load(a){
	$.ajax({
		  type: "POST",
		  url: "ajax/religion_register_load.php",
		  data: "&re_id="+a,
		  success: function(html){		
		  $("#reg_id").html(html);//Calling the responce IDs
		  }
...
function upgarde_pay(){	
	
		if(duration_food.checked==false){	
		alert("Please choose the Duration");
		duration_food.focus();
		return false;	
	}
...
function get_cms (val) {
	if(val==""){
		...
		$.ajax({
			type: "POST",
			url: "ajax/get_cms.php",	//Calling the ajax process php url				
			data:"&val=" + val, 
			success: function(html){				
				$("#cms_out").html(html);					 
			}
...
function check_mail(){
	...
	$.ajax({
		type: "POST",
		url: "ajax/1check_mail.php",	 //Calling the ajax process php url	
		data : "&email="+$('#email').val(),			
		success: function(html){					
			$("#mail_re1").html(html);	//Calling the responce IDs						
		}
	});
}

/*function user_reg_data_using_jquery(_this){
...
function thumbs_up(a,b){
	$.ajax({
		type: "POST",
		url: "ajax/thumbs_up.php",	 //Calling the ajax process php url	
		data : "&main="+a,			
		success: function(html){					
			$("#thumbs_up_out").html(html);	//Calling the responce IDs						
		}
	});
}

function thumbs_up_1(a){
	$.ajax({
		type: "POST",
		url: "ajax/thumbs_up.php",	 //Calling the ajax process php url	
		data : "&main="+a,			
		success: function(html){					
			$("#thumbs_up_out_1").html(html);	//Calling the responce IDs						
		}
	});
}

function vote_up(a,b){
	$.ajax({
		type: "POST",
		url: "ajax/vote_up.php",	 //Calling the ajax process php url	
		data : "&vote="+a+"&user_id="+b,			
		success: function(html){					
			$("#vote_up_out").html(html);	//Calling the responce IDs						
		}
	});
}
...
function txt_validate(){
		...
		if(word_txt1.value==""){
			alert("Please Enter first content");
			word_txt1.focus();
			return false;
		}	
		else if(word_txt2.value==""){
			alert("Please Enter Second content");
			word_txt2.focus();
			return false;
		}
		else if(!word_txt1.value.match(letters1)){ 
		alert("white space not allowed");
			word_txt1.focus();
			return false;
		}
		else if(!word_txt2.value.match(letters1)){ 
		alert("white space not allowed");
			word_txt2.focus();
			return false;
		}
